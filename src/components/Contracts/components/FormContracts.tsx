...
import { AgendaSettingsContract } from "./AgendaSettingsContract/AgendaSettingsContract";
    ...
    },
    {
      ...
      content: (
        <ServicesContract 
          startDate={startDate} 
          endDate={endDate} 
          onNext={(selectedServices: Service[]) => { // ✅ Se define correctamente el tipo de datos esperado
