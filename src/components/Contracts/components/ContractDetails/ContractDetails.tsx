    ...
    <div className="contract-details-container">
      ...
      <Card className="full-width-card patient-info-card">
        <div className="patient-info-container">
          <Avatar src="https://via.placeholder.com/80" size={80} className="patient-avatar" />
          ...
          <div className="patient-details">
            ...
            <Typography.Text className="patient-data">
              <strong>{patientData.documento}</strong> - {patientData.genero} - {patientData.fechaNacimiento} - {patientData.edad} años
            </Typography.Text>
            <Typography.Text className="patient-data">
        ...
        <div className="contract-header">
          <div className="title-wrapper">
            <Title level={5} className="contract-title">
              Contrato {contractData.contratoId} - Realizado por: {contractData.realizadoPor}
            </Title>
          </div>
          <div className="contract-actions">
            <Button type="default" className="edit-button">Editar</Button>
            <Button type="text" danger className="delete-button">Eliminar</Button>
          </div>
        </div>
        ...
        <div className="contract-body">
          ...
          <div className="contract-field">
            ...
            <div className="contract-status">
              <Text><strong>Facturado:</strong> {contractData.facturado}</Text>
              <div className="status-edit">
                <Text><strong>Vigente:</strong> {contractData.vigente}</Text>
                <Button type="link" className="edit-link">Editar</Button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="services-body">
        ...
        <Text className="table-subtitle">Servicios o productos incluidos</Text>
        ...
        <Table
          columns={[
            ...
            { title: "Descripción", dataIndex: "descripcion" },
            {
              ...
              render: () => (
                <>
                  <Button type="link" className="delete-link">Eliminar</Button>
                </>
              ),
            },
          ]}
      ...
      <Card className="full-width-card billing-card">
        ...
        <div className="billing-header">
          <Title level={5} className="billing-title">Facturas Generadas</Title>
          <Button className="main-button billing-add-button" icon={<PlusCircleOutlined />}>Nueva Factura</Button>
        </div>
        ...
        <Table
          columns={[
            ...
            { title: "Total", dataIndex: "total" },
            {
              ...
              render: () => (
                <>
                  <Button type="link" className="main-button-link">Editar</Button>
