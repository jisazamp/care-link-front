...
export const CreateContract = ({ onNext }: { onNext: (contractData: ContractData) => void }) => {
    ...
    <Layout style={{ padding: "24px", minHeight: "100vh" }}>
      <Card title="Editar / Agregar Contrato" style={{ marginTop: 16 }}>
        <Form layout="vertical">
          <Form.Item label="Tipo de contrato" name="contractType" rules={[{ required: true, message: "Seleccione el tipo de contrato" }]}>
          ...
          <Form.Item label="Fecha de inicio" name="startDate" rules={[{ required: true, message: "Seleccione la fecha de inicio" }]}>
            <DatePicker 
              style={{ width: "100%" }} 
              value={startDate} 
          ...
          <Form.Item label="Facturado" name="billed" rules={[{ required: true, message: "Seleccione una opción" }]}>
