...
export const ViewReport: React.FC = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_: any, record: any) => {
        return (
          <span>
            {"No"} |
            <a href="#" style={{ color: "#9957C2", marginLeft: 4 }}>
              Ver
            </a>
          </span>
        );
    ...
    },
    {
      ...
      render: (_: any, record: any) => (
        <span>
          <a style={{ marginRight: 8, color: "#9957C2" }} href="#">
            Ver
          </a>
          <a style={{ color: "#9957C2" }} href="#">
            Editar
          </a>
        </span>
      ),
                ...
                <Row align="middle" gutter={24}>
                  ...
                  <Col flex="auto">
                    ...
                    >
                      ...
                      {/* No existe campo de afiliación, se deja teléfono emergencia */}
                    ...
                    >
                      <Descriptions.Item label="Exploración física">
                        <div>
                          ...
                          <div>
                            Frecuencia cardíaca: {exploracion.frecuencia}
                          </div>
                          <div>
                            Temperatura corporal: {exploracion.temperatura}
                          </div>
                          <div>
                            Pulsioximetría: {exploracion.pulsioximetria}
                          </div>
                        </div>
                      </Descriptions.Item>
                    </Descriptions>
