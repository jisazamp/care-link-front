          ...
          <div style={{ flex: 1 }}>
            ...
            <Descriptions column={2} bordered>
              ...
              <Descriptions.Item label="N° Afiliación">
                {reportData.numeroAfiliacion}
              </Descriptions.Item>
              <Descriptions.Item label="Condiciones Médicas">
                {reportData.condiciones}
              </Descriptions.Item>
              <Descriptions.Item label="Fecha de Ingreso">
                {reportData.fechaIngreso}
              </Descriptions.Item>
            </Descriptions>
          </div>
        </div>
