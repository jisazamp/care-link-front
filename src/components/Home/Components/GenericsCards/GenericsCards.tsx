    ...
    <Row gutter={[16, 16]}>
      ...
      <Col span={8}>
        <Card className="generic-card">
          ...
          <Text strong style={{ fontSize: "24px" }}>350</Text>
          <Line {...configVisits} />
      ...
      <Col span={8}>
        <Card className="generic-card">
          ...
          <Title level={3} style={{ color: "#1890FF" }}>$8.000.000</Title>
          <Line {...configPayments} />
          <Text type="secondary">Cumplimiento de meta <strong>60%</strong></Text>
        </Card>
      </Col>
      ...
      <Col span={8}>
        <Card className="generic-card">
          ...
          <Title level={3} style={{ color: "#13C2C2" }}>78%</Title>
